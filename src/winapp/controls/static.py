...
#        if self.is_dark:
    ...
    def _on_WM_CTLCOLORSTATIC(self, hwnd, wparam, lparam):
        gdi32.SetTextColor(wparam, TEXT_COLOR_DARK if self.is_dark else 0x000000)
        gdi32.SetBkColor(wparam, self._bg_color_dark if self.is_dark else self._bg_color)
        gdi32.SetDCBrushColor(wparam, self._bg_color_dark if self.is_dark else self._bg_color)
