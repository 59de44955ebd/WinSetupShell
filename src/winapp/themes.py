...
from .common_structs import DRAWITEMSTRUCT, MEASUREITEMSTRUCT
...
DARK_TOOLBAR_BUTTON_BORDER_COLOR = 0x636363
DARK_TOOLBAR_BUTTON_BORDER_PEN = gdi32.CreatePen(PS_INSIDEFRAME, 1, DARK_TOOLBAR_BUTTON_BORDER_COLOR)

DARK_TOOLBAR_BUTTON_BG_COLOR = 0x424242
DARK_TOOLBAR_BUTTON_BG_BRUSH = gdi32.CreateSolidBrush(DARK_TOOLBAR_BUTTON_BG_COLOR)
...
TOOLBAR_BUTTON_BORDER_COLOR = 0xffe8cc
TOOLBAR_BUTTON_BORDER_PEN = gdi32.CreatePen(PS_INSIDEFRAME, 1, TOOLBAR_BUTTON_BORDER_COLOR)

TOOLBAR_BUTTON_BG_COLOR = 0xfff3e5
TOOLBAR_BUTTON_BG_BRUSH = gdi32.CreateSolidBrush(TOOLBAR_BUTTON_BG_COLOR)

TOOLBAR_BUTTON_ROLLOVER_BG_COLOR = 0xfff3e5
TOOLBAR_BUTTON_ROLLOVER_BG_BRUSH = gdi32.CreateSolidBrush(TOOLBAR_BUTTON_ROLLOVER_BG_COLOR)
