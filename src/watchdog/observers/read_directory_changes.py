        ...
        with self._lock:
            ...
            for winapi_event in winapi_events:
                ...
                if winapi_event.is_renamed_old:
                    ...
                    if winapi_event.is_dir:  #os.path.isdir(dest_path):
                    ...
                    isdir = winapi_event.is_dir  #os.path.isdir(src_path)
                    ...
                    self.queue_event(DirDeletedEvent(src_path) if winapi_event.is_dir else FileDeletedEvent(src_path))

                elif winapi_event.is_removed_self:
                    self.queue_event(BaseDirDeletedEvent(self.watch.path))
                    self.stop()
